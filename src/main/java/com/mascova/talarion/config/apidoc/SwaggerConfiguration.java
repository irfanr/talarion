package com.mascova.talarion.config.apidoc;
...
@Configuration
@EnableSwagger
@Profile({ Constants.SPRING_PROFILE_SWAGGER, Constants.SPRING_PROFILE_PRODUCTION })
public class SwaggerConfiguration implements EnvironmentAware {
  ...
  private ApiInfo apiInfo() {
    return new ApiInfo(propertyResolver.getProperty("title"),
        ...
        propertyResolver.getProperty("termsOfServiceUrl"), propertyResolver.getProperty("contact"),
