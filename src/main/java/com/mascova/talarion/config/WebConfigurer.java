...
import com.mascova.talarion.web.filter.CachingHttpHeadersFilter;
import com.mascova.talarion.web.filter.StaticResourcesProductionFilter;
import com.mascova.talarion.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
  ...
  public void onStartup(ServletContext servletContext) throws ServletException {
    ...
    if (env.acceptsProfiles(Constants.SPRING_PROFILE_METRICS, Constants.SPRING_PROFILE_PRODUCTION)) {
  ...
  private void initCachingHttpHeadersFilter(ServletContext servletContext,
    ...
    FilterRegistration.Dynamic cachingHttpHeadersFilter = servletContext.addFilter(
        "cachingHttpHeadersFilter", new CachingHttpHeadersFilter(env));
