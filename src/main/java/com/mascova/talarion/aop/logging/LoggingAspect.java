package com.mascova.talarion.aop.logging;
...
public class LoggingAspect {
  ...
  @Pointcut("within(com.mascova.talarion.repository..*) || within(com.mascova.talarion.service..*) || within(com.mascova.talarion.web.rest..*)")
  ...
  public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    try {
      ...
      log.error("Illegal argument: {} in {}.{}()", Arrays.toString(joinPoint.getArgs()), joinPoint
